...
public class Basicoflocator {
	public static void main(String[] args) throws InterruptedException {
			...
			Thread.sleep(2000);
			 ...
			 Thread.sleep(2000); //driver.findElement(By.id("LinkHeader4")).click();
			 driver.navigate().back();
			 driver.findElement(By.xpath("//a[text()='Get your copy from GitHub']")).
			 click(); //driver.findElement(By.xpath("//a[text()='Insurance']")).click();
